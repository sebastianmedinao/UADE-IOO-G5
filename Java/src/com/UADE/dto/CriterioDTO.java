...
public class CriterioDTO {
    ...
    public CriterioDTO(Integer codigo, Sexo sexo, String condicionesPreexistentes, Integer edadDesde, Integer edadHasta, String interpretacion, Float referenciaInferior, Float referenciaSuperior, String unidadMedida, Boolean reservado) {
        this.codigo = codigo;
        this.sexo = sexo;
